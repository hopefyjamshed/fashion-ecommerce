...
const UploadForm = () => {
    ...
    return (
        <div className='max-w-[1240px] mx-auto p-5 mt-3 bg-red-50'>
            ...
            <form onSubmit={handleSubmit(uploadProduct)}>
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" name="Brand Name" id="Brand" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        <label for="underline_select" name="floating_last_name" id="cloth Type" class="sr-only
                        
                        ">Underline select</label>
                        <select id="" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-400 peer">

                            <option value="US" selected>Select Product Type</option>
                            <option value="CA">SHIRT</option>
                            <option value="FR">Jeanse</option>
