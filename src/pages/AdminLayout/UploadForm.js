...
const UploadForm = () => {
    ...
    return (
        <div className='max-w-[1240px] mx-auto p-5 mt-3 bg-red-50 py-12'>
            <Link to='/admin'><button className='btn btn-circle text-[10px] p-[1px] mb-7'> go back</button></Link>
            <form onSubmit={handleSubmit(uploadProduct)}>
                ...
                {/* <div className="relative z-0 w-full mb-6 group">
                    <input type="text" name="Name Of Product" {...register('nameOfProduct')} id="NameOfProduct" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" />
                ...
                <div className="grid md:grid-cols-2 md:gap-6">
                    ...
                    <div className="relative z-0 w-full mb-6 group">
                        ...
                        {/* <label htmlFor="cloth type" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"> select A Product</label> */}
                    </div>
                </div>
